...
import cn.myzju.lib.sprinkles.exceptions.NoTableAnnotationException;
import cn.myzju.lib.sprinkles.typeserializers.TypeSerializer;

/**
 * Some changes from lychs1998
 */
class Utils {

    private static final String SCHEME_NAME = "sprinkles.db";
    private static final String QUERY_PARAMETER_TABLE_NAME = "tableName";
